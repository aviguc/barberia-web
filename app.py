...
st.markdown("<h1 style='text-align: center; color: #D4AF37;'> BARBERSHOP DISTRITO 23</h1>", unsafe_allow_html=True)
...
with col1:
    fecha = st.date_input("📅 ¿Qué día vienes?", datetime.date.today(), min_value=datetime.date.today())
